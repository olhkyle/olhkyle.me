...
const skills: Skill[] = [
  ...
  { category: 'css', techStacks: ['CSS3', 'SCSS/Sass', 'Styled-Components', 'Emotion', 'TailwindCSS'] },
  { category: 'js/ts', techStacks: ['JavaScript[ES6+]', 'TypeScript'] },
  { category: 'ui library', techStacks: ['React'] },
  { category: 'global state library', techStacks: ['Redux Toolkit', 'Recoil'] },
  { category: 'server state library', techStacks: ['RTK Query', 'React Query'] },
  { category: 'server side', techStacks: ['Node.js', 'Express'] },
